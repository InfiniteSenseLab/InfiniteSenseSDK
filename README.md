...
>1. 接线问题：[全功能同步板快速开始](./assets/全功能同步板快速开始.md)与[核心板快速开始](./assets/核心板快速开始.md)介绍了MID360与工业相机的接线。
>2. 很多小伙伴咨询同步精度，整体同步精度可以满足VIO，LO，VSLAM，LSLAM等绝大数多的算法应用，至于是否符合您的需求，需要您自己测试。
>3. 全功能板输出电源有效功率为15W，建议多(>3)工业相机用户可以采用外部供电方案。
>4. 我们正全力支持新一代同步板(V4)与[SDK2.0]([[./assets/时间同步原理.md](https://github.com/InfiniteSenseLab/InfiniteSenseSDK2.0))]的推出，主要方向包括：稳定的电源，精准协同的触发逻辑(特别加入LIVO方案支持，支持GPS)，更加易用的SDK2.0(兼容V3与MINI硬件) 。
