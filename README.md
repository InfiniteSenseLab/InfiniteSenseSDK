...
>3. 全功能版本IP设置好之后，需要更改主机IP(同一网段)。然后更改demo中的IP，才能使用。
>4. 全功能板输出电源有效功率为15W，建议多(>3)工业相机用户可以采用外部供电方案。
>5. 我们正全力支持新一代同步板推出，主要方向包括：稳定的电源，精准协同的触发逻辑(特别加入LIVO方案支持，支持GPS)，更加易用的SDK(兼容V3与MINI硬件)。
