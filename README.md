...
>4. 我们正全力支持新一代同步板(V4)与[SDK2.0](https://github.com/InfiniteSenseLab/InfiniteSenseSDK2.0)的推出，主要方向包括：稳定的电源，精准协同的触发逻辑(特别加入LIVO方案支持，支持GPS)，更加易用的SDK2.0(兼容V3与MINI硬件) 。
